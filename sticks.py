...
def number_of_sticks_to_remove(player, number_of_sticks, hat_dict):
    if player == 'AI BOT':
        number_to_remove = ai_bot_turn(number_of_sticks, hat_dict)
        number_of_sticks = number_of_sticks - number_to_remove
        print('AI Bot removed {} sticks'.format(number_to_remove))
...
def main():
    ...
    game_choice = which_game()
    user_one = input('Please enter player 1\'s name: ')

    user_two = user_name_two(game_choice)

    print('player1: {} \nplayer2: {}\n'.format(user_one, user_two))
    ...
    while number_of_sticks > 0:
        ...
        number_of_sticks = number_of_sticks_to_remove(player, number_of_sticks, hat_dict)
